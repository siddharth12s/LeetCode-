<h2><a href="https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/?envType=problem-list-v2&envId=binary-search&difficulty=MEDIUM">1011. Capacity To Ship Packages Within D Days</a></h2><h3>Medium</h3><hr><p>A conveyor belt has packages that must be shipped from one port to another within <code>days</code> days.</p>
